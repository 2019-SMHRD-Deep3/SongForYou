...
<body class="homepage is-preload">
		...
		<div id="header">
			...
			<div class="inner">
				...
				<footer>
					...
					<table><tr><td><input type=button value = Login onClick="location.href='loginpage.jsp'"></td>
					<td><pre>             </pre></td><td><input type=button value = "Join  " onClick="location.href='joinpage1.jsp'"></td></tr>
					</table>
	...
	<%if (info !=null){
		...
		<br>
			...
			<table>
					<tr><td align = right><input id=input type=text placeholder="노래를 입력해 주세요."></td>
					<td align = left><input id=search type=submit value=검색></td>
		</tr>	</table>	</form>
			</header>
		</section>
<%} %>
